...
export function EmergencyPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl bg-[#050d13] p-1">
      <section className="border-2 border-rose-400/70 bg-gradient-to-b from-rose-950/35 to-[#050d13] p-5 sm:p-8">
        ...
        {emergencySimulation && (
          <p className="mt-3 flex items-center gap-2 text-xs font-bold tracking-[.13em] text-sev-high-soft">
            <Siren size={14} />
        ...
        <p className="mt-3 text-sm font-bold text-command-soft">
        ...
        {hasEmergencyLevel && (
          <div className="mt-5 flex items-start gap-3 rounded-xl border border-rose-300/40 bg-rose-500/20 p-4">
            ...
            <p className="text-sm font-black tracking-[.14em] text-rose-100">
              ...
              {emergencySimulation && (
                <span className="ml-2 rounded-md border border-sev-high/45 bg-sev-high/15 px-2 py-0.5 text-[10px] tracking-[.13em] text-sev-high-soft">
                  SIMULATION/DEMO
                </span>
              )}
              {origin === 'live' && (
        ...
        <div className="mt-5 flex items-start gap-3 rounded-xl border border-sev-high/40 bg-sev-high/15 p-4 text-sm leading-6 text-sev-high-soft">
        ...
        {!riskAvailable && (
          <div className="mt-5 rounded-xl border border-sev-high/40 bg-sev-high/15 p-4 text-sm leading-6 text-sev-high-soft">
        ...
        <div className="mt-8 grid gap-4">
          <div className="grid min-w-0 gap-4 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,.95fr)]">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <button
            ...
            className="rounded-xl bg-command px-5 py-3 text-sm font-bold text-[#052033] transition hover:bg-command-soft"
          >
            VIEW EVACUATION ROUTE
          </button>
          <button
            onClick={() => navigate('/safe-places')}
            className="rounded-xl border border-command/40 px-5 py-3 text-sm font-bold text-command-soft transition hover:bg-command/10"
          >
            VIEW SAFE PLACES
          </button>
          <button
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          <div className="border border-white/15 bg-black/25 p-5">
            <p className="text-xs font-bold tracking-[.14em] text-command-soft">RECOMMENDED SAFE PLACE</p>
          ...
          <div className="border border-white/15 bg-black/25 p-5">
            <p className="text-xs font-bold tracking-[.14em] text-command-soft">EVACUATION ROUTE</p>
            <h2 className="mt-2 text-xl font-bold text-white">{place?.name}</h2>
            <p className="mt-2 text-slate-300">
              {route
          ...
          <div className="border border-white/15 bg-black/25 p-5">
            <p className="text-xs font-bold tracking-[.14em] text-command-soft">EMERGENCY CONTACTS</p>
        ...
        {event && (
          <div className="mt-4 border border-white/15 bg-black/25 p-5">
            <p className="text-xs font-bold tracking-[.14em] text-command-soft">
            ...
            {event.secondaryHazards && event.secondaryHazards.length > 0 && (
              <div className="mt-3 flex flex-wrap gap-2">
                {event.secondaryHazards.map((hazard) => (
                  <span
                    key={hazard.name}
                    className="border border-sev-high/35 bg-sev-high/15 px-2 py-1 text-xs text-sev-high-soft"
                  >
