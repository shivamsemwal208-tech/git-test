    ...
    <div className="relative h-[430px] overflow-hidden rounded-2xl border border-white/10">
      ...
      >
        ...
        <CircleMarker
          center={[location.latitude, location.longitude]}
          radius={11}
          pathOptions={{ color: '#38bdf8', fillColor: '#075985', fillOpacity: 0.9 }}
        >
          <Popup>
            <b>{location.name}</b>
            <br />
        ...
        {layers.landslide && (
          <Circle
            ...
            radius={1500}
            pathOptions={{ color: '#cf6f53', fillColor: '#cf6f53', fillOpacity: elevatedExposure ? 0.35 : 0.15 }}
          >
            <Popup>
        ...
        {layers.route && route && (
          <Polyline positions={route.coordinates} pathOptions={{ color: '#7dd3fc', weight: 5 }}>
          ...
          seismic
            ...
            .map((event) => (
              <CircleMarker
                ...
                radius={9}
                pathOptions={{ color: '#5b8db4', fillColor: '#5b8db4', fillOpacity: 0.9 }}
              >
                <Popup>
      ...
      <div className="absolute bottom-3 left-3 z-[500] rounded-lg border border-white/20 bg-abyss/90 px-3 py-2 text-[10px] font-semibold text-command-soft shadow-lg">
