...
def test_feature_schema_canonical_ordering_and_units():
    ...
    # optional river_distance_m (no source in this release).
...
def test_live_feature_vector_uses_real_providers(
    ...
    # River distance is optional: the provider has no source in this release,
    # so the canonical vector carries None (never a guessed value).
    assert vector["river_distance_m"] is None
